...
export const headingDescription = document.querySelector('.profile__heading-description');
export const inputEditProfileName = popupEditProfile.querySelector('.popup__input_type_name');
export const inputEditProfileAbout = popupEditProfile.querySelector('.popup__input_type_about');
export const inputAddCardName = popupAddCard.querySelector('.popup__input_type_name');
export const inputAddCardLink = popupAddCard.querySelector('.popup__input_type_link');
...
export const closeButtonEditProfile = popupEditProfile.querySelector('.popup__button-close');
export const closeButtonAddCard = popupAddCard.querySelector('.popup__button-close');
export const imagePopup = document.querySelector('.popup_image')
export const closeButtonImage = imagePopup.querySelector('.popup__button-close');
